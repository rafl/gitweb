...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{GITWEB_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{GITWEB_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
gitweb_server.pl - Catalyst Testserver

=head1 SYNOPSIS

gitweb_server.pl [options]
